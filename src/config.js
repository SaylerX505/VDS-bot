...
const xpMessageCooldownMs = Number(process.env.XP_MESSAGE_COOLDOWN_MS || 60000);
const xpMin = Number(process.env.XP_MIN || 15);
const xpMax = Number(process.env.XP_MAX || 25);
